...
export const runs = pgTable("runs", {
  ...
  // ── Post-run coaching insight (generated by plan reassessment or comprehensive analysis) ──
  // Stores the AI-generated assessment of this specific run: why the training load was
